...
set shortmess=aoO
badd +96 ~/workspace_tb/rss_client/src/hongbosb/tbdemo/MainActivity.java
badd +49 ~/workspace_tb/Android-PullToRefresh/sample/src/com/handmark/pulltorefresh/samples/PullToRefreshListActivity.java
...
wincmd =
argglobal
iabbr <buffer> #m public static void main(String[] args)
iabbr <buffer> #p System.out.println
...
let s:l = 21 - ((11 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
normal! 010l
lcd ~/workspace_tb/rss_client
wincmd w
argglobal
edit ~/workspace_tb/Android-PullToRefresh/sample/src/com/handmark/pulltorefresh/samples/PullToRefreshListActivity.java
iabbr <buffer> #m public static void main(String[] args)
iabbr <buffer> #p System.out.println
iabbr <buffer> #i import
setlocal keymap=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 58 - ((10 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
normal! 04l
lcd ~/workspace_tb/Android-PullToRefresh/sample
wincmd w
wincmd =
if exists('s:wipebuf')
